...
function animate() {
  ...
  tl.addLabel('frame_2', 4)
    ...
    .to(burger1, 0.5, { scale: 1.35, x: 102, y: 2, ease: "linear", }, "frame_2+=.5")
    .to(burger2, 0.5, { scale: 1.3, x: 0, y: 0, autoAlpha: 1, ease: "linear", }, "frame_2+=.5")
  ...
  tl.addLabel('frame_3', 8)
    ...
    .to(burger1, 1, { scale: 1.425, x: 0, y: 0, ease: "linear", }, "frame_3")
